CREATE TYPE "public"."inventory_log_change_type" AS ENUM('ORDER_FULFILLMENT', 'RESERVATION_CREATED', 'RESERVATION_CONSUMED', 'RESERVATION_EXPIRED', 'RESERVATION_RELEASED', 'STOCK_ADJUSTMENT');--> statement-breakpoint
